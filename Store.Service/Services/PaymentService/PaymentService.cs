...
namespace Store.Service.Services.PaymentService
{
    public class PaymentService : IPaymentService
    {
        ...
        public async Task<CustomerBasketDto> CreateOrUpdatePaymentIntent(CustomerBasketDto customerBasket)
        {
            ...
            else
            {
                ...
                await service.UpdateAsync(customerBasket.PaymentIntentId , options);
            }
